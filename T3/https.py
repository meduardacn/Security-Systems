...
# Si = hashlib.sha256(bytes(str(V), 'utf-8')).hexdigest().upper()[:32]    # V em int
# print("Si")
# print(Si)
# Sh = hashlib.sha256(bytes(hex(V)[2:], 'utf-8')).hexdigest().upper()[:32]    # V em hex
# print("Sh")
# print(Sh)

Sba = hashlib.sha256(bytes.fromhex("0%x" % V )).hexdigest()[:32] # V em bytearray de hex
print("S")
print(Sba.upper())
Sba = bytes.fromhex(Sba)
